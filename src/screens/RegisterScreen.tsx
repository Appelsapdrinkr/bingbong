...
export function RegisterScreen({
  ...
  const authErrorMessage = useAppSelector((state) => state.auth.registerForm.errorMessage);
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        ...
        <Formik
          ...
          onSubmit={async (values, { setSubmitting }) => {
            ...
            try {
              await onRegister(values.email.trim(), values.password);
            } catch {
              dispatch(
                setRegisterErrorMessage("Unable to register right now. Please try again."),
              );
            } finally {
              setSubmitting(false);
            }
